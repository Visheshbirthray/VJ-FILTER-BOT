...
API_ID = int(environ.get('API_ID', '20715932'))
API_HASH = environ.get('API_HASH', 'f6fc543fae67279f36ed21e84b1f0f57')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '2168941517'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6656382786 2123118741').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '2249571243').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://visheshbirthray9:<password>@cnxraoshab.rnpwd.mongodb.net/?retryWrites=true&w=majority&appName=CnxRaoshab")
